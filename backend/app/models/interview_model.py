...
class InterviewSession(Base):
    """
    SQLAlchemy model representing a complete interview session instance.
    Tracks user, chosen difficulty, mode, generated questions, and overall status.
    """
...
class InterviewQuestion(Base):
    """
    SQLAlchemy model acting as a junction table between an InterviewSession and a Question.
    Represents a specific question asked during a specific interview session.
    """
...
class Answer(Base):
    """
    SQLAlchemy model representing a user's submitted answer to an InterviewQuestion.
    Stores the user's text as well as the AI's evaluation score, feedback, and metadata.
    """
