...
class Subject(Base):
    """
    SQLAlchemy model representing an interview subject or topic category.
...
class Question(Base):
    """
    SQLAlchemy model representing a reusable question in the question bank.
    Contains the question text, difficulty, Bloom's taxonomy level, and expected answer time.
    """
